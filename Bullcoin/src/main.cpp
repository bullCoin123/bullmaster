...
uint256 hashGenesisBlock("0x4d232bb07c659e4025ce23d71325c8e1af8631118b19a563e0f7148f57c46a8f");
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60;; // Bullcoin: 1 Day
static const int64 nTargetSpacing = 10 * 60; // Bullcoin: 10 Minutes.
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4d232bb07c659e4025ce23d71325c8e1af8631118b19a563e0f7148f57c46a8f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "This is Bullcoin 10 Feb 2017";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1486754243;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3558480;
        ...
        assert(block.hashMerkleRoot == uint256("0x2e054d5e9dfccc7fe4bc6a06bcab45db9366d1014f131b77a41556766e11d7a9"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Bullcoin: increase each by adding 2 to bitcoin's value.
